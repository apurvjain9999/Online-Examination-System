<%-- 
    Document   : delete
    Created on : 22 May, 2019, 6:58:45 PM
    Author     : HP
--%>
    ...
    <body>
        ...
        <%
            try {
                ...
                int ct = 0;
                String sql = "select count(*) from question_master";
                ...
                if(count!=0) {
                    ...
                    st = con.createStatement();
                    for(int i=0; i<ct; i++) {
                        st.executeUpdate("delete from question_master where ques_id='" + id[i] + "'");
        ...
        %>    
                            ...
                            <tr>
                                <td align="center">    
        <a href="QuestionList.jsp" align = "center">
            <button type="submit">
                Continue
            </button>
        </a>
