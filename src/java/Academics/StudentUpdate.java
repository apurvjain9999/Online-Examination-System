    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (studentid != null) {
            try {
                ...
                String query = "Update student set dob='" + dateofbirth + "',name = '" + name + "',telephone='" + telephone + "',mobile='" + mobile + "',class = '" + course + "',email='" + emailid + "',father='" + father + "',occupation='" + occupation + "',present='" + presentaddress + "',state='" + state + "',city='" + city + "' where id='" + studentid + "'";
